...
(hl! :DiffAdd {:bg palette.bg-added-faint :fg palette.fg-added})
(hl! :DiffChange {:bg palette.bg-changed-faint :fg palette.fg-changed})
(hl! :DiffDelete {:bg palette.bg-removed-faint :fg palette.fg-removed})
(hl! :DiffText {:bg palette.bg-changed-refine :fg palette.fg-changed})
(hl! :Directory {:fg palette.accent-0})
(hl! :EndOfBuffer {:fg palette.fg-dim})
(hl! :ErrorMsg {:fg palette.err})
(hl! :ExtraWhitespace {:bg palette.bg-space-err})
...
(hl! :ModeMsg {:fg palette.fg-main} :bold)
(hl! :MoreMsg {})
(hl! :MsgArea {:fg palette.fg-main})
(hl! :MsgSeparator {})
(hl! :NonText {})
...
(hl! :Question {:fg palette.info})
(hl! :QuickFixLine {:bg palette.bg-completion} :bold)
(hl! :Search {:bg palette.bg-search-lazy :fg palette.fg-main})
(hl! :SignColumn {:bg palette.bg-dim})
(hl! :SnippetTabstop {:bg palette.bg-hover :fg palette.fg-main})
(hl! :SpecialKey {:link :Whitespace})
(hl! :SpellBad {:sp palette.underline-err} :undercurl)
(hl! :SpellCap {:sp palette.underline-warning} :undercurl)
(hl! :SpellLocal {:sp palette.underline-note} :undercurl)
(hl! :SpellRare {:sp palette.underline-note} :undercurl)
...
(hl! :Substitute {:bg palette.bg-search-replace})
(hl! :TabLine {:bg palette.bg-tab-other})
(hl! :TabLineFill {:bg palette.bg-tab-bar})
(hl! :TabLineSel {:bg palette.bg-tab-current})
(hl! :TermCursor {:link :Cursor})
(hl! :TermCursorNC {:link :TermCursor})
(hl! :Title {:fg palette.fg-heading-0})
(hl! :Visual {:bg palette.bg-region :fg palette.fg-region})
(hl! :VisualNOS {:link :Visual})
(hl! :WarningMsg {:fg palette.warning})
(hl! :Whitespace {:fg palette.fg-space})
(hl! :WildMenu {:link :PmenuSel})
(hl! :WinBar {:link :TabLineSel})
(hl! :WinBarNC {:link :TabLine})
