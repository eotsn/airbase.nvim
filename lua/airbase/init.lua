...
vim.api.nvim_set_hl(0, "DiffAdd", {bg = palette["bg-added-faint"], fg = palette["fg-added"]})
vim.api.nvim_set_hl(0, "DiffChange", {bg = palette["bg-changed-faint"], fg = palette["fg-changed"]})
vim.api.nvim_set_hl(0, "DiffDelete", {bg = palette["bg-removed-faint"], fg = palette["fg-removed"]})
vim.api.nvim_set_hl(0, "DiffText", {bg = palette["bg-changed-refine"], fg = palette["fg-changed"]})
vim.api.nvim_set_hl(0, "Directory", {fg = palette["accent-0"]})
vim.api.nvim_set_hl(0, "EndOfBuffer", {fg = palette["fg-dim"]})
vim.api.nvim_set_hl(0, "ErrorMsg", {fg = palette.err})
vim.api.nvim_set_hl(0, "ExtraWhitespace", {bg = palette["bg-space-err"]})
...
vim.api.nvim_set_hl(0, "ModeMsg", {fg = palette["fg-main"], bold = true})
vim.api.nvim_set_hl(0, "MoreMsg", {})
vim.api.nvim_set_hl(0, "MsgArea", {fg = palette["fg-main"]})
...
vim.api.nvim_set_hl(0, "Question", {fg = palette.info})
vim.api.nvim_set_hl(0, "QuickFixLine", {bg = palette["bg-completion"], bold = true})
...
vim.api.nvim_set_hl(0, "SnippetTabstop", {bg = palette["bg-hover"], fg = palette["fg-main"]})
vim.api.nvim_set_hl(0, "SpecialKey", {link = "Whitespace"})
vim.api.nvim_set_hl(0, "SpellBad", {sp = palette["underline-err"], undercurl = true})
vim.api.nvim_set_hl(0, "SpellCap", {sp = palette["underline-warning"], undercurl = true})
vim.api.nvim_set_hl(0, "SpellLocal", {sp = palette["underline-note"], undercurl = true})
vim.api.nvim_set_hl(0, "SpellRare", {sp = palette["underline-note"], undercurl = true})
...
vim.api.nvim_set_hl(0, "Substitute", {bg = palette["bg-search-replace"]})
...
vim.api.nvim_set_hl(0, "TermCursorNC", {link = "TermCursor"})
vim.api.nvim_set_hl(0, "Title", {fg = palette["fg-heading-0"]})
...
vim.api.nvim_set_hl(0, "Whitespace", {fg = palette["fg-space"]})
